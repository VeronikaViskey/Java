...
// Домашнее задание
    @Override
    public synchronized void sendMsgTo(ClientHandler from, String to, String msg) {
        for (ClientHandler client : clients) {
            if (client.getName().equals(to)) {
                client.sendMessage("from " + from.getName() + ": " + msg);
                return;
            }
        }
        from.sendMessage("Client " + to + " is not here ");
    }
    //
